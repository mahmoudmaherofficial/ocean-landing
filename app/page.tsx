    ...
    <main className="overflow-x-hidden pt-24 lg:pt-28 antialiased">
      <div className="relative container">
        <Image
          ...
          width={1920}
          height={1080}
          className="absolute -z-50 w-full min-h-screen md:max-h-[670px] lg:min-h-screen md:h-full -top-20 left-0 opacity-10"
        />
        {/* Home Section */}
        ...
        >
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
            ...
            <div className="flex flex-col gap-4 items-center text-center lg:items-start lg:text-start">
              <Heading title="Powerful features to help you manage all leads." />
              <p className="lg:max-w-[34rem] leading-normal sm:text-lg sm:leading-8">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                Reprehenderit accusamus officia voluptate dicta, provident sit
                quas culpa. Eos repudiandae voluptates eum incidunt
              </p>
          ...
          {/* Part 1 */}
          {/* Part 2 */}
          {featuresBlock.map((featureBlock, index) => (
            <FeatureBlock key={index} {...featureBlock} />
          ))}
          {/* Part 2 */}
        </section>
        {/* Features Section */}
        ...
        <section id="testimonials" className="flex flex-col gap-8">
          <Heading title="Meet our Customers" centered />
